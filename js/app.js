...
window.addEventListener("load", function() {
    ...
    // applies event listeners to keyboard events and holds an array of currently active keys
    class InputHandler { 
        constructor(){
            this.keys = [];
            this.touchY = ""; // initial start of vertical cordinate
    ...
    class Player {
        constructor(gameWidth, gameHeight){
            ...
            this.frameY = 0;
            this.maxFrame = 8;
            this.fps = 20; // indicates how fast swaps every animation frame
            this.frameTimer = 0;
    ...
    function displayStatusText(context){
        ...
        if (gameOver){
            ...
            context.fillStyle = "black";
            context.fillText("Press enter or swipe down to restart", canvas.width/2, 270);
            context.fillStyle = "white";
            context.fillText("Press enter or swipe down to restart", canvas.width/2 + 2, 272);
        }
    }
